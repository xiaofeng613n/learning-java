...
public class MyIdleStateHandler extends ChannelDuplexHandler {
    ...
    private final ChannelFutureListener writeListener = new ChannelFutureListener() {
        ...
        public void operationComplete(ChannelFuture future) throws Exception {
            count++;
            System.out.println("=============  writeListener  ============  count : " + count);
     ...
     */
    public MyIdleStateHandler(boolean observeOutput,
                              long readerIdleTime, long writerIdleTime, long allIdleTime,
                              TimeUnit unit) {
        if (unit == null) {
    ...
    private final class WriterIdleTimeoutTask extends AbstractIdleTask {
        ...
        @Override
        protected void run(ChannelHandlerContext ctx) {
            System.out.println("######### WriterIdleTimeoutTask is run ");
            long lastWriteTime = MyIdleStateHandler.this.lastWriteTime;
